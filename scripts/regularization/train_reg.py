...
from pml_schnet.model import SchNetRegularized
from pml_schnet.settings import device
from pml_schnet.training import train_schnet_energy_force_mem, train_schnet_energy_force
...
if __name__ == "__main__":
    ...
    model = SchNetRegularized(running_mean_var=True).to(device)
